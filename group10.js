...
function openMap1(evt, mapName) {
    ...
    if (!mapCreated) {
        ...
        var Stadia_AlidadeSmoothDark = L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png?api_key={apiKey}', {
            minZoom: 0,
            maxZoom: 20,
            ...
            ext: 'png',
            apiKey: 'c50f31a2-e162-4ea0-983b-f066af0a5427'
        });
